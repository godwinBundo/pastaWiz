...
const BookTable = () => {
  return (
    <div className="bg-pattern bg-cover bg-no-repeat text-white tablet:px-0 py-24 px-40">
        <div className="flex items-center justify-center gap-x-2 tablet:gap-0" >
            <img className="tablet:relative right-28" src={leaf}  />
            <h1 className="text-5xl font-extrabold tablet:text-3xl tablet:absolute tablet:left-20">BOOK A TABLE</h1>
        </div>
        <div className="flex items-center gap-10 mt-20 tablet:flex-col ">
           <form className="grid grid-cols-2 gap-5 w-full tablet:flex tablet:flex-col tablet:px-2">
           ...
           <div className="flex flex-col">
            ...
            <div className="w-3/4  bg-black text-white px-6 py-16 tablet:px-0 tablet:w-[300px]">
